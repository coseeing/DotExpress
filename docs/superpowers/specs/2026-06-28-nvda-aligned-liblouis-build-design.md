...
The runtime Python files are regenerated from the synchronized vendor snapshot:

- `client/braille/louis_helper.py` comes from `vendor/nvda/liblouis/runtime/louis_helper.py`
- `client/braille/liblouis/__init__.py` comes from `vendor/nvda/liblouis/python/__init__.py.in` with the liblouis DLL name substituted during generation
...
2. Synchronize NVDA integration into vendor:
   ...
   - regenerate the tracked runtime Python files from the synced vendor snapshot
...
3. Regenerate and review the tracked runtime Python files under `client/braille/`.
4. Review changes under `vendor/nvda/liblouis/`.
5. Run `scripts/build-liblouis.bat`.
6. Run verification commands and manual checks.
7. Commit the submodule pointer update, vendor sync changes, runtime file updates, and any related documentation/test changes.
...
- `scripts/tests/test_sync_nvda_liblouis.py` passes.
...
- `client/braille/louis_helper.py` matches `vendor/nvda/liblouis/runtime/louis_helper.py`.
- `client/braille/liblouis/__init__.py` matches the generated output from `vendor/nvda/liblouis/python/__init__.py.in`.
